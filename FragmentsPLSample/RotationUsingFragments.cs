...
{
    //[Activity(Label = "RotationUsingFragments", MainLauncher = true, Icon = "@drawable/launcher")]
    [Activity(Label = "RotationUsingFragments")]
    public class RotationUsingFragments : Activity
    {
        protected override void OnCreate(Bundle savedInstanceState)
        {
            base.OnCreate(savedInstanceState);
            SetContentView(Resource.Layout.rotationUsingFragments);
